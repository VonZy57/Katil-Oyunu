...
public class TalkWithNeighbor : MonoBehaviour
{
    ...
    void BuildDialog()
    {
        dialogLines = new List<SubtitleLine>
        {
            ...
            {
                speakerName = "Mother",
                lineText = new LocalizedText { english = "Okay, let's go get it one more time. But if you touch the raw cake, I'll **** on your bed.", turkish = "Tamam hadi bir bardak daha olsun. Ama elin pişmemiş keke giderse sıçarım yatağına." },
